...
extension ExtensionManager: WKWebExtensionControllerDelegate {
    ...
    func webExtensionController(
        ...
        let pending = PendingWindow(id: pendingID, initialURL: firstURL, completion: completionHandler, timeoutTask: timeoutTask)
        pendingWindows[pendingID] = pending
        NotificationCenter.default.post(name: .openNewWindowFromExtension, object: firstURL)
    }
